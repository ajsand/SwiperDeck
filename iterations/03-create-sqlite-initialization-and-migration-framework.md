...
- *Using SQLite* by Jay A. Kreibich (O’Reilly): https://www.oreilly.com/library/view/using-sqlite/9781449394592/
- *Designing Data-Intensive Applications* by Martin Kleppmann (migration/change-management principles): https://dataintensive.net/
- *SQL Antipatterns* by Bill Karwin (schema pitfalls to avoid early): https://pragprog.com/titles/bksap1/sql-antipatterns/
