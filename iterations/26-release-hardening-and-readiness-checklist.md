...
2. *Site Reliability Engineering* (Beyer, Jones, Petoff, Murphy)
3. *Designing Data-Intensive Applications* (Martin Kleppmann) — reliability/data consistency chapters
4. *The Pragmatic Programmer* (Hunt & Thomas) — defensive coding and operational readiness
