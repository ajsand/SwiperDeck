...
- _Designing Data-Intensive Applications_ (transactional consistency intuition): https://dataintensive.net/
- _Refactoring UI_ (interaction trust and recovery patterns): https://www.refactoringui.com/
