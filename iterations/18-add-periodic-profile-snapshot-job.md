...
- _Designing Data-Intensive Applications_ (state snapshots, correctness): https://dataintensive.net/
- _Release It!_ (stability, failure isolation): https://pragprog.com/titles/mnee2/release-it-second-edition/
- _Refactoring_ (isolating pure decision logic): https://martinfowler.com/books/refactoring.html
