...
1. _Unit Testing: Principles, Practices, and Patterns_ (Vladimir Khorikov)
2. _xUnit Test Patterns_ (Gerard Meszaros)
3. _Working Effectively with Legacy Code_ (Michael Feathers)
