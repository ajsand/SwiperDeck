...
1. _Web Performance in Action_ (Jeremy L. Wagner)
2. _High Performance Browser Networking_ (Ilya Grigorik)
3. _Designing Data-Intensive Applications_ (Martin Kleppmann) — useful for throughput/latency trade-offs and consistency decisions
